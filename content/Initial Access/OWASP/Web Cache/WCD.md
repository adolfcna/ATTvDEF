...
> [!warning] Application vs Cache Interpretation
...
> ```
>
> The attacker therefore does not necessarily need direct access to the victim's private endpoint.
>
...
> [!example] Find Sensitive Endpoints
...
> [!warning] Make the Endpoint Look Static
...
> [!warning] URL Normalization and Bypasses
...
> [!danger] Encoding and Parser Differences
...
> [!abstract] Detection Methodology
