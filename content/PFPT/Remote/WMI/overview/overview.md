...
```
gwmi -Query "select * from Win32_Process where Name = 'explorer.exe'"
```
...
```
gcim Win32_Directory -Filter "Name = 'C:\\Windows\\System32'" | Get-CimAssociatedInstance -Association Win32_Subdirectory | select Name
```
```
